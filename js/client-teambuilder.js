	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		focus: function () {
			if (this.curTeam) {
				...
				if (this.curTeam.format.includes('okls5')) {
					this.curTeam.dex = Dex.mod('gen9nationaldexokls5');
				}
		...
		renderSet: function (set, i) {
			...
			var isNatDex = this.curTeam.format.includes('nationaldex') || this.curTeam.format.includes('natdex') || this.curTeam.format.includes('okls5');
			var buf = '<li value="' + i + '">';
			if (!set.species) {
				if (this.deletedSet) {
